...
void	sort_3(t_stack *stack_a)
{
	if (stack_a->stack[0] == stack_a->mini
		&& stack_a->stack[1] == stack_a->maxi)
	{
		reverse_rotate_a(stack_a);
		swap_a(stack_a);
	}
	else if (stack_a->stack[1] == stack_a->maxi
		&& stack_a->stack[2] == stack_a->mini)
		reverse_rotate_a(stack_a);
	else if (stack_a->stack[1] == stack_a->mini
		&& stack_a->stack[2] == stack_a->maxi)
		swap_a(stack_a);
	else if (stack_a->stack[0] == stack_a->maxi
		&& stack_a->stack[1] == stack_a->mini)
		rotate_a(stack_a);
	else if (stack_a->stack[0] == stack_a->maxi
		&& stack_a->stack[2] == stack_a->mini)
	{
